...
<div class="container">
    <div class="row" style="margin-top: 30px">
        <div class="text-center m-t-20 mt-20 bg-primary" style="padding: 20px">
            <img class="text-center" src="<?php echo e(asset('assets/img/logo.png')); ?>" style="max-width: 240px" alt="Home"/>
        </div>
...
<?php /**PATH E:\laragon\www\booking\resources\views/vendor/froiden-envato/install_message.blade.php ENDPATH**/ ?>