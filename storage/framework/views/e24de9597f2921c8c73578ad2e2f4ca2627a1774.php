                ...
                <div class="col-lg-4 col-12 my-lg-0 my-2">
                    <ul class="head-contact-left">
                        <li>
                            ...
                            <?php echo e($settings->formatted_phone_number); ?>
                        ...
                        <li class="location-search mb-3">
                            ...
                            <div class="location-dropdown">
                                <div id="scrollable-dropdown-menu" class="input-wrap">
                                    ...
                                    <input id="location" class="typeahead" type="text" placeholder="<?php echo app('translator')->getFromJson('modules.booking.selectLocation'); ?>">
                                </div>
                            </div>
                        </li>
    ...
    <script>
        ...
        $(function () {
            ...
            $('#scrollable-dropdown-menu .typeahead').typeahead(null, {
                ...
                templates: {
                    notFound: '<div id="noLocation"><?php echo app('translator')->getFromJson('front.noLocationFound'); ?></div>'
                }
            });
            ...
            if (localStorage.getItem('location')) {
                ...
                $('.typeahead').typeahead('val', '<?php echo app('translator')->getFromJson('front.allLocations'); ?>');
                localStorage.setItem('location', '<?php echo app('translator')->getFromJson('front.allLocations'); ?>');
            }
                        ...
                        success: function (response) {
                            ...
                            if (response.services.length > 0) {
                                response.services.forEach(service => {
                                    var defaultAsset = '<?php echo e(asset('assets/img/pl-slide1.jpg')); ?>';
                                    var asset = '<?php echo e(asset('user-uploads/service/').'/'); ?>'+service.image;
...
<?php $__env->stopPush(); ?>
<?php /**PATH E:\laragon\www\booking\resources\views/sections/header.blade.php ENDPATH**/ ?>