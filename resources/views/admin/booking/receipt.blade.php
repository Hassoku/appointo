    ...
    <table border="0" cellspacing="0" cellpadding="0">
        ...
        @foreach($booking->items as $key=>$item)
                <tr style="page-break-inside: avoid;">
                    ...
                    <td class="qty"><h3>{!! $settings->currency->currency_symbol.number_format((float)$item->unit_price, 2, '.', '') !!}</h3></td>
                    <td class="unit">{!! $settings->currency->currency_symbol.number_format((float)($item->businessService->discounted_price  * $item->quantity), 2, '.', '') !!}</td>
                </tr>
        @endforeach
        <tr style="page-break-inside: avoid;" class="subtotal">
            ...
            <td class="unit">{{ $settings->currency->currency_symbol.number_format((float)$booking->original_amount, 2, '.', '') }}</td>
        </tr>
        ...
        <tr style="page-break-inside: avoid;" class="discount">
            ...
            <td class="unit">-{{ $settings->currency->currency_symbol.number_format((float)$booking->discount, 2, '.', '') }}</td>
        </tr>
        @endif
        ...
        <tr style="page-break-inside: avoid;" class="tax">
            ...
            <td class="unit">{{ $settings->currency->currency_symbol.number_format((float)$booking->tax_amount, 2, '.', '') }}</td>
        </tr>
        @endif
        </tbody>
        <tfoot>
        <tr dontbreak="true">
            ...
            <td style="text-align: center">{{ $settings->currency->currency_symbol.number_format((float)$booking->amount_to_pay, 2, '.', '') }}</td>
        </tr>
        </tfoot>
    </table>
